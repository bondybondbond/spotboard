...
- **Capture mode now shows what a click will capture** (#106): hovering in capture mode pins a small label to the outlined box — "This box will be captured · click, then Grow for more" — so you can see the scope before you click and know it can be widened afterwards. The top bar now says "hover to preview, click on any content you want to add".
